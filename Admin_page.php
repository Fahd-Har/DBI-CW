...
<aside class="sidebar">
  ...
  <div class="sidebar-sub">Internship Result Management System</div>
  <ul class="sidebar-nav">
    <li><a href="Admin_page.html" class="active"><img src="home.png" alt="Home Icon" class="icon"/> Dashboard</a></li>
    <li><a href="User_Management_Student.html"><img src="users.png" alt="Users Icon" class="icon"/> Student Management</a></li>
    <li><a href="User_Management_Lecturer.html"><img src="users.png" alt="Users Icon" class="icon"/> Lecturer Management</a></li>
    <li><a href="User_Management_IndustrySupervisor.html"><img src="users.png" alt="Users Icon" class="icon"/> Industry Supervisor Management</a></li>
    <li><a href="Internship_management.html"><img src="internship.png" alt="Internships Icon" class="icon"/> Internship Management</a></li>
    <li><a href="Result_Viewing.html"><img src="results.png" alt="Results Icon" class="icon"/> Result Viewing</a></li>
  </ul>
  <div class="sidebar-footer">
    Logged in as<br><span>Admin</span>
    &nbsp;·&nbsp; <a href="login.html" style="color:#e74c3c;text-decoration:none;">Logout</a>
  </div>
</aside>
...
<main class="main">
  ...
  <div class="modules-grid">
    ...
    <!-- Internship Management -->
    <div class="module-card intern" onclick="window.location.href='Internship_management.html'">
      <div class="mod-icon">
        <img src="internship.png" alt="Internships Icon" class="icon"/>
      </div>
      <div>
    ...
    <!-- Result Viewing -->
    <div class="module-card result" onclick="window.location.href='result_viewing.html'">
      <div class="mod-icon">
        <img src="results.png" alt="Results Icon" class="icon"/>
      </div>
      <div>
...
>>>>>>> 7cef1bc (Update code to include Company Supervisor and fix logic):Admin_page.html
